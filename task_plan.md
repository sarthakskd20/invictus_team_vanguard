...
**Task 3.4.3: CAD BOM Import [1 hour]**
- [ ] Implement BOM import from CAD files (KiCad/Eagle/PDF) using Antigravity Skill
- [ ] Add "Import BOM from CAD" button to BOM Builder
- [ ] Parse uploaded file via backend (using `parse_bom.py` logic)
- [ ] Auto-populate component list from parsed BOM
- [ ] Test with sample KiCad/Eagle files
